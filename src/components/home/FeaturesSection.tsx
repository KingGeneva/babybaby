  ...
  const features = [
    {
      ...
      description: "Enregistrez et visualisez la croissance de votre enfant avec des graphiques intuitifs et personnalisés.",
      icon: (
    ...
    },
    {
      ...
      description: "Gérez les rendez-vous médicaux et suivez le calendrier de vaccination de votre enfant.",
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" className="h-7 w-7 text-babybaby-cosmic" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
    ...
    },
    {
      ...
      description: "Découvrez et suivez les étapes clés du développement de votre enfant mois par mois.",
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" className="h-7 w-7 text-babybaby-cosmic" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
